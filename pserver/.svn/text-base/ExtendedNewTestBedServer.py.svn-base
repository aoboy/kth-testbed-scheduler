...
casesList  = [CONF_CHANNEL_CH_26, CONF_CHANNEL_CH_11, CONF_CHANNEL_CH_12,
              CONF_CHANNEL_CH_13, CONF_CHANNEL_CH_14,
              CONF_CHANNEL_CH_15, CONF_CHANNEL_CH_16, CONF_CHANNEL_CH_17, CONF_CHANNEL_CH_18,
              CONF_CHANNEL_CH_19, CONF_CHANNEL_CH_20, CONF_CHANNEL_CH_21, CONF_CHANNEL_CH_22,
              CONF_CHANNEL_CH_23, CONF_CHANNEL_CH_24, CONF_CHANNEL_CH_25]
...
def experimentRun(snode):
    ...
    for s in supernodes[:]:
        ...
        gatewaysList.append(Gateway(s, casesList[:1]))
    ...
    for currCase in casesList[:1]:
        folderName = 'Task21SingleCase/Task2Exp1Ch'+str(currCase)+'/'
        ...
        for g in gatewaysList[:]:
            ...
            for node in nodesList:
                ...
                if int(currCase) >= CONF_CHANNEL_CH_11  and int(currCase) <= CONF_CHANNEL_CH_26:

                    fileCase = 'SingleChannels'+str(experiment_cases[currCase])+'n'+str(len(channel_cache[int(currCase)]))
                    ...
                    sleepApp(12) #sleep a while (22)
                    print '===>Programming FMrSenderNode:',nodeID, ' as RX Node'
                    remoteFileName='case'+str(currCase)+'isa_receiver.ihex'
                    targetNode.programNodeWithIHEXFile(remoteFileName)
