...
#casesList  = [CONF_CHANNEL_CH_11, CONF_CHANNEL_CH_12, CONF_CHANNEL_CH_13, CONF_CHANNEL_CH_14,
...
#             CONF_CHANNEL_CH_23, CONF_CHANNEL_CH_24, CONF_CHANNEL_CH_25, CONF_CHANNEL_CH_26]
...
def retrieveData(snode, caseid, folder):
    ...
    queue = Queue.Queue()
    for g in gatewaysList[:]:
        gTh = ParallelizeGatewayOps(queue, 'remoteFileName', 'download')
...
def experimentRun(snode):
    ...
    #gatewaysList.append(Gateway('192.168.200.10', casesList))
